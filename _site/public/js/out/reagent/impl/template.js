...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20765__auto__,writer__20766__auto__,opt__20767__auto__){
return cljs.core._write.call(null,writer__20766__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__21888 = o;
(G__21888[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21889__delegate = function (args){
...
return G__21889__delegate.call(this,args);};
...
return G__21889__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__20147__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__20147__auto__){
var and__20147__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__21897 = jsprops;
(G__21897["defaultValue"] = value);

(G__21897["onChange"] = ((function (G__21897,v,value,on_change){
return (function (p1__21894_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21894_SHARP_);
});})(G__21897,v,value,on_change))
);

(G__21897["ref"] = ((function (G__21897,v,value,on_change){
return (function (p1__21895_SHARP_){
return (this$["cljsInputElement"] = p1__21895_SHARP_);
});})(G__21897,v,value,on_change))
);
...
var vec__21904 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21904,(0),null);
var id = cljs.core.nth.call(null,vec__21904,(1),null);
var class$ = cljs.core.nth.call(null,vec__21904,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___21909 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21909 == null)){
} else {
var key_21910 = temp__4661__auto___21909;
(jsprops["key"] = key_21910);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__21912 = (new reagent.impl.template.NativeWrapper());
(G__21912["name"] = c);
...
var len__21234__auto___21918 = arguments.length;
var i__21235__auto___21919 = (0);
while(true){
if((i__21235__auto___21919 < len__21234__auto___21918)){
args__21241__auto__.push((arguments[i__21235__auto___21919]));

var G__21920 = (i__21235__auto___21919 + (1));
i__21235__auto___21919 = G__21920;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21242__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21916){
var G__21917 = cljs.core.first.call(null,seq21916);
var seq21916__$1 = cljs.core.next.call(null,seq21916);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__21917,seq21916__$1);
});
...
break;
default:
var G__21924 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__21924;
continue;
...
var n__21074__auto___21927 = a.length;
var i_21928 = (0);
while(true){
if((i_21928 < n__21074__auto___21927)){
(a[i_21928] = reagent.impl.template.as_element.call(null,(a[i_21928])));

var G__21929 = (i_21928 + (1));
i_21928 = G__21929;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21074__auto___21930 = a.length;
var i_21931 = (0);
while(true){
if((i_21931 < n__21074__auto___21930)){
var val_21932 = (a[i_21931]);
if((cljs.core.vector_QMARK_.call(null,val_21932)) && ((reagent.impl.template.key_from_vec.call(null,val_21932) == null))){
(o["no-key"] = true);
} else {
}

(a[i_21931] = reagent.impl.template.as_element.call(null,val_21932));

var G__21933 = (i_21931 + (1));
i_21931 = G__21933;
continue;
} else {
}
...
var ctx = ({});
var vec__21937 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21937,(0),null);
var derefed = cljs.core.nth.call(null,vec__21937,(1),null);
...
var G__21941 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21941) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__21941){
...
//# sourceMappingURL=template.js.map?rel=1499477028133