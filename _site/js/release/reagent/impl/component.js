...
if((i < len)){
var k = (ks[i]);
var G__9590 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__9591 = (i + (1));
m = G__9590;
i = G__9591;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__9595 = c;
var G__9595__$1 = (((G__9595 == null))?null:G__9595.prototype);
if((G__9595__$1 == null)){
return null;
} else {
return (G__9595__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__9599 = c;
var G__9599__$1 = (((G__9599 == null))?null:G__9599.prototype);
if((G__9599__$1 == null)){
return null;
} else {
return (G__9599__$1["render"]);
}
})()));
});
...
return (function() { 
var G__9605__delegate = function (args){
var G__9603 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__9603) : reagent.impl.component.as_element.call(null,G__9603));
};
...
return G__9605__delegate.call(this,args);};
G__9605.cljs$lang$maxFixedArity = 0;
G__9605.cljs$lang$applyTo = (function (arglist__9607){
var args = cljs.core.seq(arglist__9607);
return G__9605__delegate(args);
});
...
var _STAR_current_component_STAR_9610 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_9610;
}});
...
var G__9618 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__9618) {
...
return ((function (G__9618){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__9621 = reagent.impl.component.state_atom(c);
var G__9622 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__9621,G__9622) : cljs.core.reset_BANG_.call(null,G__9621,G__9622));
});
;})(G__9618))
...
var c = this;
var G__9624_9626 = (c["cljsRatom"]);
if((G__9624_9626 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9624_9626);
}
...
var renders_9629 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_9630 = cljs.core.first(cljs.core.vals(renders_9629));
if((cljs.core.count(renders_9629) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_9629))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_9630)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_9630], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__9628 = name;
switch (G__9628) {
case "":
...
var elem = (function (){var G__9639 = (function (){var or__6409__auto__ = (function (){var G__9641 = c;
if((G__9641 == null)){
return null;
} else {
return (G__9641["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
...
return (G__9639["_currentElement"]);
}
})();
var name = (function (){var G__9642 = elem;
var G__9642__$1 = (((G__9642 == null))?null:(G__9642["type"]));
if((G__9642__$1 == null)){
return null;
} else {
return (G__9642__$1["displayName"]);
}
})();
var path = (function (){var G__9643 = elem;
var G__9643__$1 = (((G__9643 == null))?null:(G__9643["_owner"]));
var G__9643__$2 = (((G__9643__$1 == null))?null:reagent$impl$component$component_path(G__9643__$1));
if((G__9643__$2 == null)){
return null;
} else {
return [cljs.core.str(G__9643__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__9645 = c;
var G__9645__$1 = (((G__9645 == null))?null:G__9645.constructor);
if((G__9645__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__9645__$1);
}
}
})();
